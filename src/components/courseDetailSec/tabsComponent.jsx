                ...
                <div className={`${toggle === menuData[0] ? "block" : "hidden"}`}>
                    ...
                    <div>
                        ...
                        <div className="flex md:justify-start justify-center items-center xl:gap-5 gap-3 flex-wrap mt-8">
                            <button className="flex items-center gap-3 bg-whiteShade shadow-boxShadow rounded cursor-pointer xl:py-4 py-3 2xl:px-9 xl:px-8 lg:px-4 px-8 duration-300 group hover:-translate-y-1">
                    ...
                    <div className="grid md:grid-cols-[auto_1fr] sm:grid-cols-2 xl:gap-8 gap-5">
                        ...
                        <div>
                            ...
                            <ul className="flex items-center md:gap-8 gap-5 mt-6">
                                <li>
                                    <Link to="#">
                                        <img className="max-w-6 duration-300 hover:-translate-y-1" src={facebookSvg} alt="" />
                                    </Link>
                                </li>
                                <li>
                                    <Link to="#">
                                        <img className="max-w-6 duration-300 hover:-translate-y-1" src={linkedInSvg} alt="" />
                                    </Link>
                                </li>
                                <li>
                                    <Link to="#">
                                        <img className="max-w-6 duration-300 hover:-translate-y-1" src={youtubeSvg} alt="" />
                                    </Link>
                                </li>
                                <li>
                                    <Link to="#">
                                        <img className="max-w-6 duration-300 hover:-translate-y-1" src={instagram2Svg} alt="" />
                                    </Link>
                                </li>
                                <li>
                                    <Link to="#">
                                        <img className="max-w-6 duration-300 hover:-translate-y-1" src={twitterSvg} alt="" />
                                    </Link>
                                </li>
                            </ul>
                        </div>
