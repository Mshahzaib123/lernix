            ...
            <div className="container">
                <div className="flex gap-6 lg:flex-row flex-col">
                    ...
                    <div className="lg:w-1/2 2xl:ml-10 xl:ml-5 ml-0">
                        ...
                        <div className="relative overflow-hidden bg-grey100 grid sm:grid-cols-[auto_1fr] items-center lg:gap-7 gap-4 sm:py-5 sm:px-10 p-5 rounded-lg duration-500 before:content-[''] before:absolute before:top-0 before:left-0 before:bg-primary lg:before:w-1/6 sm:before:w-1/12 before:w-0 before:h-full before:duration-500 group hover:before:w-full">
                        ...
                        <ul className="grid sm:grid-cols-2 gap-6 xl:mt-10 xl:mb-8 mt-7 mb-6">
                            {[...Array(4)].map((_, i) => (
                                <li key={i} className="grid grid-cols-[auto_1fr] items-center xl:gap-x-5 gap-x-3">
