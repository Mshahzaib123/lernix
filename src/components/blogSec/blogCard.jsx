...
const BlogCard = ({ data }) => {
    return (
        <div className="bg-whiteShade rounded-xl shadow-boxShadow xl:py-5 xl:pb-6 xl:px-5 p-4 duration-300 group hover:shadow-boxShadow2">
            <div className="relative">
                <Link to={`/blog-detail/${data.id}`} className="w-full overflow-hidden rounded-xl">
                    <img className="w-full duration-500 group-hover:scale-105" src={data.blogImg} alt="Blog" />
                </Link>
