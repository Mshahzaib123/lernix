        ...
        <div className="bg-whiteShade rounded-xl shadow-boxShadow xl:py-5 xl:pb-6 xl:px-5 p-4 duration-300 group hover:-translate-y-2.5 hover:shadow-boxShadow2">
            <div className="relative">
                ...
                <div className="absolute left-1/2 -bottom-7 2xl:w-80 xl:w-[295px] w-60 transform -translate-x-1/2">
                    <ul className="flex justify-between items-center bg-whiteShade xl:py-4 xl:px-7 p-3.5 rounded-lg">
                        <li className="flex items-center xl:gap-5 gap-2.5 ">
                            <User className='text-primary' size={20} />
                            <TitleComponent size='base-medium' className='text-lightGrey'>{data.user}</TitleComponent>
                        </li>
                        <li className="flex items-center xl:gap-5 gap-2.5">
                            <Calendar className='text-primary' size={20} />
                            <TitleComponent size='base-medium' className='text-lightGrey'>{data.datePosted}</TitleComponent>
                        </li>
                    </ul>
                </div>
            </div>
            <div className="pt-12 text-center">
                ...
                <div className="mt-5">
                    <Link to={data.path} className="flex items-center justify-center gap-2 duration-300 group/btn">
