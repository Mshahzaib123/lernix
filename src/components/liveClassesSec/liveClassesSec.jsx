                ...
                <div className="relative">
                    ...
                    <div className="absolute left-1/2 -translate-x-1/2 xl:bottom-12 lg:bottom-8 md:bottom-5 bottom-2.5">
                        <ul className="flex items-center md:gap-x-4 gap-x-2">
                            <li>
                                <Link to="#" className="flex items-center justify-center xl:w-16 xl:h-16 lg:w-12 lg:h-12 md:w-11 md:h-11 w-9 h-9 bg-white rounded-full duration-300 hover:-translate-y-1.5">
                                    <SpeakerSimpleX className='text-black xl:text-2xl lg:text-xl md:text-lg text-base' weight='fill' />
                                </Link>
                            </li>
                            <li>
                                <Link to="#" className="flex items-center justify-center xl:w-16 xl:h-16 lg:w-12 lg:h-12 md:w-11 md:h-11 w-9 h-9 rounded-full bg-lightRed100 duration-300 group hover:bg-lightPink100 hover:-translate-y-1.5 ">
                            ...
                            <li>
                                <Link to="#" className="flex items-center justify-center xl:w-16 xl:h-16 lg:w-12 lg:h-12 md:w-11 md:h-11 w-9 h-9 rounded-full bg-secondary duration-300 group hover:bg-lightPink100 hover:-translate-y-1.5">
