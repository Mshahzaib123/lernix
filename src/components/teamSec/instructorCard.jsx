        ...
        <div>
            ...
            <div className="relative -mt-28 mx-5">
                ...
                <div className="absolute top-0 right-5 z-50 duration-300 group">
                    <div className="absolute -top-7 right-0 flex justify-center items-center xl:w-16 xl:h-16 lg:w-12 lg:h-12 md:w-14 md:h-14 w-12 h-12 bg-primary rounded cursor-pointer visible opacity-100 duration-300 group-hover:top-0">
