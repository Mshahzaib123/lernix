    ...
    return (
        <div className="border-2 border-dashed border-primary rounded-xl xl:p-5 p-4 group">
            <div className="rounded-xl overflow-hidden">
                <img className="w-full object-center duration-300 group-hover:scale-110" src={data.img} alt="Team" />
            </div>
            <div className="text-center md:pt-6 pt-5">
                ...
                <div className="flex justify-center items-center gap-5">
                    {socialData.slice(0, 3).map((item, index) => (
                        <Link key={index} to={item.path} className="flex justify-center items-center w-9 h-9 bg-primary rounded-full duration-300 group hover:bg-black">
