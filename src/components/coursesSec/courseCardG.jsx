            ...
            <div className="2xl:py-7 2xl:px-6 p-5">
                ...
                <div className="flex items-center justify-between pt-5 border-t-[1px] border-solid border-greyLight">
                    ...
                    <Link className="flex items-center gap-2 group" to='/courses-detail'>
                        <TitleComponent size='base-semibold' className='uppercase md:text-base text-sm text-primary duration-300 group-hover:text-secondary'>Enroll Now</TitleComponent>
                        <ArrowRight className='text-primary duration-300 group-hover:text-secondary' weight='bold' size={16} />
                    </Link>
                </div>
            </div>
        </div>
