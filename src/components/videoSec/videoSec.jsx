            ...
            <div className="container">
                <div className="bg-videoBg bg-no-repeat bg-center bg-cover rounded-xl lg:p-16 p-10">
                    <div className="flex justify-between items-center gap-6 sm:flex-row flex-col">
                        <h1 className="max-sm:w-56 max-xs:w-full stroker xl:text-[80px] lg:text-6xl md:text-5xl text-[40px] font-lexend leading-normal uppercase text-transparent">INTRO
                            <span className="flex xl:ml-32 xs:ml-[90px] ml-12">VIDEO</span>
                        </h1>
                        <div className="relative flex justify-center xl:w-[336px] md:w-60 sm:w-44 w-full">
